...
const LeftWrapper = styled.div`
  ...
  height: 40%;
  ${mobile({ padding: "10px", alignItems: "center", justifyContent: "center", textAlign: "center", height: "100%" })}
`;
    ...
    <Container>
      <Left>
        <LeftWrapper>
          ...
          <BigName>Pepe</BigName>
          <Title>
            <TitleWrapper>
              <TitleItem>Web Developer</TitleItem>
              <TitleItem>React</TitleItem>
              <TitleItem>Redux</TitleItem>
              <TitleItem>Nextjs</TitleItem>
              <TitleItem>Oracle SQL Developer</TitleItem>
            </TitleWrapper>
          </Title>
          <Description>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum corporis itaque qui asperiores nihil adipisci laudantium, molestiae et
            praesentium fugiat! Mollitia voluptatem, tempore amet similique perferendis delectus sed modi dolore.
          </Description>
        </LeftWrapper>
        <Icon width="75" height="75" viewBox="0 0 75 75" fill="none" stroke="black" className="i-scroll" xmlns="http://www.w3.org/2000/svg">
          <g id="scroll">
